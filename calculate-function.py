...
c = add_numbers(a, b)
print(f"Die Summer von a= {a} und b= {b} ist {c}")

d = add_numbers(c, 5)
print(f"Die Summe von c= {c} und 5 ist d= {d}")

e = power(b, a)
print(f"{b} hoch {a} ist gleich {e}")

print(f"{a} Quadrat ist {power(a)}")
print(f"{b} Qudarat ist {power(b)}")

print(f"Der Mittelwert von 10, 20 und 30 ist {average(10, 20, 30)}")
print(f"Der Mittelwert von 1, 2, 3 und 4 ist {average(1, 2, 3, 4)}")
...
print(f"Der Mittelwert aller Einkaeaufe ist {average(purchase1, purchase2, purchase3)}")
